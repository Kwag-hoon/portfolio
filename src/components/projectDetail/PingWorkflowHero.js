    ...
    <section className="ping-workflow-hero">
      <div className="ping-workflow-hero__container">
        <div className="ping-workflow-hero__grid">
          ...
          <div className="ping-workflow-hero__diagram">
            <img
              src={workflowBase}
            ...
            {workflowSteps.map((step) => (
              <button
                key={step.id}
                type="button"
                className={`ping-workflow-hero__marker ping-workflow-hero__marker--${step.modifier} ${activeStep === step.id ? "is-active" : ""
                  }`}
